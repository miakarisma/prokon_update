...
<body>
  ...
  <?= \Config\Services::validation()->listErrors();?>
    ...
    <h3>Text-Header</h3>
    <textarea name="text_header" rows="4" cols="50" placeholder="Text data yang sekarang"><?= $frontPage['text_header'];?></textarea>
    <h3>Text-Span</h3>
    <textarea name="text_span" rows="4" cols="50" placeholder="Text data yang sekarang"><?= $frontPage['text_span'];?></textarea>
